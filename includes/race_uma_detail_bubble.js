const columns = {
    ...
    chokyo_den_oikiri_5f_wood_kubun: "ウッドコース 5Fタイム区分",
    chokyo_den_oikiri_4f_wood_kubun: "ウッドコース 4Fタイム区分",
    chokyo_den_oikiri_1f_wood_kubun: "ウッドコース 1Fタイム区分",
    chokyo_den_oikiri_4f_hanro_kubun: "坂路コース 4Fタイム区分",
    // 印（Shirushi）カラム
    shirushi_hanro_4f_flag: "調教推奨印 坂路タイム 全体タイムが同レース出走馬の中でで最も速い 該当馬は「はい」それ以外はnull",
    shirushi_hanro_1f_flag: "調教推奨印 坂路タイム 最後の1Fタイムが同レース出走馬の中で最も速い 該当馬は「はい」それ以外はnull",
    shirushi_wood_4f_flag: "調教推奨印 ウッドタイム 4Fからのタイムが最も速い馬 該当馬は「はい」それ以外はnull",
    shirushi_wood_1f_flag: "調教推奨印 ウッドタイム 最後の1Fタイム同レース出走馬の中でが最も速い 該当馬は「はい」それ以外はnull",
    shirushi_awase_senchaku_flag: "調教推奨印 併せ馬 先着している馬 該当馬は「はい」それ以外はnull",
    shirushi_point: "印ポイント",
    shirushi_kubun_yosou_tansho_ninkijun: "予想人気順区分",
    shirushi_kubun_rank: "人気区分内順位",
    shirushi_shirushi_label: "予想印ラベル",
    shirushi_shirushi_num: "予想印数値",
    chokyo_den_oikiri_ichidori: "調教位置取り",
    chokyo_den_oikiri_ichidori_label: "調教位置取り(ラベル)",
    ...
    chokyo_den_oikiri_check_time_1f_flag: "調教1～3追い切り 1Fの標準タイムクリア判定のフラグ",
    chokyo_den_oikiri_check_time_4f_6f_flag: "調教1～3追い切り 4F/6Fの標準タイムクリア判定のフラグ",
    // スピード指数・ローテーション
    // 調教 (sei2由来)
    chokyo_sei_flag: "競走成績出走馬データ  追い切り 調教フラグ",
    chokyo_sei_flag_label: "競走成績出走馬データ  追い切り chokyo_flagをもとに対応 はい/いいえ",
    ...
    chokyo_sei_5f_wood_kubun: "競走成績出走馬データ  追い切り ウッドコース5Fタイム区分",
    chokyo_sei_4f_wood_kubun: "競走成績出走馬データ  追い切り ウッドコース4Fタイム区分",
    chokyo_sei_1f_wood_kubun: "競走成績出走馬データ  追い切り ウッドコース1Fタイム区分",
    chokyo_sei_4f_hanro_kubun: "競走成績出走馬データ  追い切り 坂路コース4Fタイム区分",
    chokyo_sei_ichidori: "競走成績出走馬データ  追い切り 調教位置取り",
    chokyo_sei_ichidori_label: "競走成績出走馬データ  追い切り 調教位置取り(ラベル)",
