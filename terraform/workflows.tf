...
main:
  ...
  steps:
    ...
    - callExportRaceUmaOddsFunction:
        call: http.post
        args:
          url: "${google_cloudfunctions2_function.export_race_uma_odds.service_config[0].uri}"
          timeout: 1800
          auth:
            type: OIDC
        result: exportRaceUmaOddsResult
    - returnResult:
        return:
          ...
          exportRaceUmaOdds: $${exportRaceUmaOddsResult.body}
EOF
}
